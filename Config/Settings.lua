...
Bagshui:AddComponent(function()
  ...
  do
    ...
    for _, bagUsageDisplay in ipairs(bagUsageDisplayOrder) do
      table.insert(bagUsageDisplayChoices, {
  ...
  for _, inventoryType in ipairs(BS_INVENTORY_TYPE_UI_ORDER) do
    ...
    if inventoryConfig.opensViaHooks then
      ...
      for _, containerId in ipairs(Bagshui.config.Inventory[inventoryType].containerIds) do
        local bagName = (containerId == inventoryConfig.primaryContainer.id) and inventoryConfig.primaryContainer.name
  ...
  for _, profileTypeKey in pairs(BS_PROFILE_ORDER) do
    ...
    table.insert(defaultProfileSettings, {
    ...
    profileSettings[profileTypeKey] = {
      ...
      choicesAutoSplitMenuTooltipTextFunc = function(_, _, inventory)
        return string.format(L.Setting_Profile_Use, L[inventory.inventoryType], L["Profile_" .. profileType])
          .. BS_NEWLINE
          .. GRAY_FONT_COLOR_CODE
          .. L.Setting_Profile_SetAllHint
  ...
  Bagshui.config.Settings = {
    ...
    [BS_SETTING_APPLICABILITY.INVENTORY] = {
...

      {
        ...
        tooltipText = L.Menu_Settings_DesignColors_TooltipText
          .. BS_NEWLINE
          .. LIGHTYELLOW_FONT_COLOR_CODE
          .. L.Menu_Settings_ActiveDesignProfileHint
          .. FONT_COLOR_CODE_CLOSE,
        settings = {
...

      {
        ...
        tooltipText = L.Menu_Settings_DesignSize_TooltipText
          .. BS_NEWLINE
          .. LIGHTYELLOW_FONT_COLOR_CODE
          .. L.Menu_Settings_ActiveDesignProfileHint
          .. FONT_COLOR_CODE_CLOSE,
...

      {
        ...
        tooltipText = L.Menu_Settings_DesignView_TooltipText
          .. BS_NEWLINE
          .. LIGHTYELLOW_FONT_COLOR_CODE
          .. L.Menu_Settings_ActiveDesignProfileHint
          .. FONT_COLOR_CODE_CLOSE,
        settings = {
...

          {
            ...
            textDisplayFunc = function(name, settingName, settings)
              return name
                .. (
                  settings.hideGroupLabelsOverride and (LIGHTYELLOW_FONT_COLOR_CODE .. " ×" .. FONT_COLOR_CODE_CLOSE)
                  or ""
                )
            end,
