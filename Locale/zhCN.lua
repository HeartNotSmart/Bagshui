Bagshui:LoadComponent(function()
  BsLocalization:AddLocale("zhCN", {
    ...
    ["Slash_Help_ItemInfo"] = "/Bagshui !!Info!! 示例:"
      .. BS_NEWLINE
      .. "   /Bagshui !!Info!! 13444"
      .. BS_NEWLINE
    ...
    ["Toolbar_HighlightChanges_TooltipText"] = "切换最近更改物品的高亮显示。"
      .. BS_NEWLINE
    ...
    ["ItemList_NewPrompt"] = "要添加的物品的标识符："
      .. BS_NEWLINE
      .. GRAY_FONT_COLOR_CODE
      .. "可以是 ID、物品链接/物品字符串或数据库 URL。"
      .. BS_NEWLINE
      .. "用空格、制表符、逗号、分号或换行符分隔多个。"
    ...
    ["CategoryEditor_Field_sequence_TooltipText"] = "控制类别评估的顺序。"
      .. BS_NEWLINE
      .. "0 = 第一个，100 = 最后一个",
    ...
    ["RuleFunction_BagType_ExampleDescriptionExtra1"] = "检查物品是否在当前角色的专业特定背包中。"
      .. GRAY_FONT_COLOR_CODE
      .. BS_NEWLINE
      .. "ProfessionBag 是此功能的特殊触发器，必须不在引号中。"
      .. FONT_COLOR_CODE_CLOSE,
    ["RuleFunction_BagType_ExampleExtra2"] = "BagType(AllProfessionBags)",
    ["RuleFunction_BagType_ExampleDescriptionExtra2"] = "检查物品是否在任何专业特定容器中。"
      .. GRAY_FONT_COLOR_CODE
      .. BS_NEWLINE
      .. "AllProfessionBags 是此功能的特殊触发器，必须不在引号中。"
      .. FONT_COLOR_CODE_CLOSE,
    ...
    ["RuleFunction_Equipped_ExampleDescription1"] = "检查物品是否已装备（适用于匹配未绑定的装备）。"
      .. GRAY_FONT_COLOR_CODE
      .. BS_NEWLINE
      .. "你也可以传递与 EquipLocation() 相同的参数，以仅匹配特定的背包槽位。"
      .. FONT_COLOR_CODE_CLOSE,
    ...
    ["RuleFunction_MatchCategory_ExampleDescription1"] = "检查物品是否与内置的钥匙类别匹配。"
      .. BS_NEWLINE
      .. LIGHTYELLOW_FONT_COLOR_CODE
      .. "内置类别的ID是字符串，可能与其名称不匹配。"
      .. FONT_COLOR_CODE_CLOSE,
    ["RuleFunction_MatchCategory_Example2"] = "MatchCategory(5)", -- DO NOT LOCALIZE THE PARAMETER.
    ["RuleFunction_MatchCategory_ExampleDescription2"] = "检查物品是否与自定义类别5匹配。"
      .. BS_NEWLINE
      .. LIGHTYELLOW_FONT_COLOR_CODE
      .. "自定义类别有数字ID。",
    ...
    ["RuleFunction_MatchCategory_ExampleDescription4"] = "检查物品是否与任何指定的类别匹配。"
      .. BS_NEWLINE
      .. LIGHTYELLOW_FONT_COLOR_CODE
      .. "请记住，内置类别使用必须加引号的字符串，自定义类别使用数字。",
    ...
    ["disableAutomaticResort_TooltipText"] = "当背包窗口关闭并重新打开时，不自动分类和排序物品。"
      .. BS_NEWLINE
      .. LIGHTYELLOW_FONT_COLOR_CODE
      .. "这与将默认排序顺序设置为手动不同。"
      .. FONT_COLOR_CODE_CLOSE,
    ...
    ["windowDoubleClickActions_TooltipText"] = "双击背包窗口的空白部分以显示/隐藏所有工具栏。"
      .. BS_NEWLINE
      .. "Alt+双击以切换位置锁定。",
    ...
    ["showClam_TooltipText"] = "显示贝壳按钮以快速打开贝壳。"
      .. BS_NEWLINE
      .. LIGHTYELLOW_FONT_COLOR_CODE
      .. "仅适用于背包。"
      .. FONT_COLOR_CODE_CLOSE,
    ...
    ["showDisenchant_TooltipText"] = "显示分解按钮。"
      .. BS_NEWLINE
      .. LIGHTYELLOW_FONT_COLOR_CODE
      .. "仅适用于拥有附魔专业的角色和背包。"
      .. FONT_COLOR_CODE_CLOSE,
    ...
    ["showFooter_TooltipText"] = "显示底部工具栏。"
      .. BS_NEWLINE
      .. LIGHTYELLOW_FONT_COLOR_CODE
      .. "隐藏此选项将隐藏物品下方的所有内容，包括背包栏和金钱显示。"
      .. FONT_COLOR_CODE_CLOSE,
    ...
    ["showHeader_TooltipText"] = "显示顶部工具栏。"
      .. BS_NEWLINE
      .. LIGHTYELLOW_FONT_COLOR_CODE
      .. "隐藏此选项将隐藏物品上方的所有内容，包括关闭按钮，因此你需要通过键绑定、动作栏按钮或宏来关闭。"
      .. FONT_COLOR_CODE_CLOSE,

    ["showHearthstone"] = "炉石按钮",
    ["showHearthstone_TooltipText"] = "显示炉石按钮。"
      .. BS_NEWLINE
      .. LIGHTYELLOW_FONT_COLOR_CODE
      .. "仅适用于背包。"
      .. FONT_COLOR_CODE_CLOSE,
    ...
    ["showPickLock_TooltipText"] = "显示开锁按钮。"
      .. BS_NEWLINE
      .. LIGHTYELLOW_FONT_COLOR_CODE
      .. "仅适用于盗贼和背包。"
      .. FONT_COLOR_CODE_CLOSE,
